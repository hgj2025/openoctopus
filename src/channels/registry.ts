...
// All channels are now loaded as plugins; no built-in channel implementations remain.
...
// No built-in aliases; all channel aliasing is handled by plugin metadata.
