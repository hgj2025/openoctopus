...
// OutboundSendDeps: previously held channel-specific send functions; now empty
// after built-in channels were removed. Use an empty interface so intersections work.
